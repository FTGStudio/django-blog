...
urlpatterns = [
    ...
    url(r'^archive/month/(?P<year>\d+)/(?P<month>\w+)$','django.views.generic.date_based.archive_month',
    {
    ...
    url(r'^archive/week/(?P<year>\d+)/(?P<week>\d+)$','django.views.generic.date_based.archive_week',
    {
        'queryset': Post.objects.all(),
        'date_field': 'created_on',
    },
